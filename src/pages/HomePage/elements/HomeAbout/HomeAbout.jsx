      ...
      <div className="container">
        <div className="home-about__wrapper">
          <div className="home-about__info">
            ...
            <p>
              Escape to paradise at Angsana Laguna Phuket beachfront resort! Immerse yourself in
              Asia’s first integrated resort located on the tranquil shores of Bang Tao Bay and the
            ...
            <p>
              Enjoy savings on stays, spa sessions and dining along with exclusive benefits like
              late checkouts, free use of non-motorised watersports and much more. Click below for
              more info and start planning your dream vacation today!
            </p>

            <div className="home-about__info-button-wrapper">
              <button
                onClick={() => dispatch(openModal())}
                className="home-about__info-button blue-button blocked">
                Read more
              </button>
            </div>
          </div>
