                        ...
                        <div className="footer__info">
                            <div className="footer__logo">
                                <div className="footer__icon">
                                    <img src={MainLogo} alt='Angsana logo'/>
                                </div>
                            ...
                            <div className="footer__contact">
                                ...
                                <p className="footer__phone">Phone number: <a href="#">+66 (0)76 362 333 </a></p>
                                <p className="footer__mail">Email: <a href="#">info@lagunaproperty.com</a></p>
                            </div>
                        </div>
                            ...
                            <div className="footer__links">
                                ...
                                <div className="footer__column">
                                    ...
                                    <div className="footer__socials-wrapper">
                                        ...
                                        <a href="#" className="footer__link">Snap Chat</a>
                                    </div>
                                </div>
                            </div>
